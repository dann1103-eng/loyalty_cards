...
// en lib/google/servirLogoClase.ts). 404 solo si algo no existe (el comercio, su logo, el programa). Lo
// demás es 502: un error al leer la base; un bucket que no responde —NUNCA una redirección al logo
// crudo, porque Google lo cachearía bajo esta URL versionada y el logo recortado quedaría puesto hasta
// el próximo cambio de logo o de color; con el 502 el próximo sync reintenta—; y un "logo" que ni sharp
// puede leer, cuyos bytes nunca se reenvían tal cual.
