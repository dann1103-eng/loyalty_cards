...
// FormularioControles.tsx (ver el comentario largo de ese archivo) — un Server Action resetea el
// formulario al terminar, y un reset solo deja la casilla como el dueño la dejó si el campo es NO
// controlado. Este formulario es de EDICIÓN (a diferencia de FormularioRegla, que es de alta), así
// que necesita lo mismo.
    ...
    <form key={clave} className="panel" style={{ marginTop: 0 }} action={ejecutar}>
      ...
      <div className="field">
        ...
        {/* type="text", NO type="url": un input type="url" dispara la validación nativa del
            ...
            tiene sus propios mensajes en español, fijados en resenaGoogle.test.ts. Mismo criterio
            que el campo del mínimo de compra en FormularioControles.tsx: preferimos el mensaje
            propio al del navegador. */}
        <input
