...
afterEach(async () => {
  ...
  // antes) → tarjetas → programas_tarjeta (que tarjetas referencia) → recompensas → clientes →
  // comercios → cuentas (comercios.cuenta_id → cuentas, así que los comercios se borran antes que
  // sus cuentas).
