// El nombre con que el PANEL nombra a un cliente: el escáner, la lista y la ficha de Clientes, y la
// lista de clientes del admin. Nada más — el saludo del portal ("Hola, María") y el reporte de
// mejores clientes siguen con el nombre solo (decisión 7 del spec del 2026-09-17), y el CSV lleva
// el apellido en su propia columna, sin pasar por acá.
//
