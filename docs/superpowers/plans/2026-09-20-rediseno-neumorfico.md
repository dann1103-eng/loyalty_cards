...
[tema alto-contraste] --error sobre --error-suave∘--fondo: 6.67:1 < 7 (pastilla inactiva)
[tema alto-contraste] regla .pastilla-inactivo: --error sobre --error-suave∘--fondo: 6.67:1 < 7 (pastilla inactiva)
```
...
```css
  /* 16% y no 22%: con 22% la pastilla "inactivo" daba 6.67:1, y en este tema todo texto pide 7:1.
     Es su único uso. */
